...
本文适用于 `Bathroom Spatial Studio v1.0.0` 发布包。该版本用于功能验证和
...
```powershell
$expected = (Get-Content .\bathroom-spatial-studio-v1.0.0.sha256).Split()[0]
$actual = (Get-FileHash .\bathroom-spatial-studio-v1.0.0.zip -Algorithm SHA256).Hash.ToLowerInvariant()
