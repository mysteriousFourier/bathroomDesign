...
export const studioApi = {
  ...
  setModelAssetTag: (projectId: string, assetId: string, tag: ImportedModelAsset['correction_tag']) => request<ImportedModelAsset>(`/api/projects/${projectId}/model-assets/${assetId}/tag`, { method: 'PUT', headers: jsonHeaders, body: JSON.stringify({ tag }) }),
