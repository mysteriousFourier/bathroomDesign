...
export const modelDimensions: Record<string, ModelDimension> = {
  ...
  '浴室柜': { category: '浴室柜', file_name: '洗面盆04.fbx', width_mm: 800, depth_mm: 500, height_mm: 560, status: 'verified' },
  '适老浴室柜': { category: '适老浴室柜', file_name: '洗面盆04.fbx', width_mm: 800, depth_mm: 500, height_mm: 560, status: 'verified', note: '暂无独立适老柜模型，沿用同品类柜体几何' },
