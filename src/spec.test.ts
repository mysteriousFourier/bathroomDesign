...
describe('dry wet zones and wall finishes', () => {
  ...
  it('uses circles for supply and drainage points and a square for floor drains', () => {
    ...
    expect(fixturePointUsage({ id: 'washer-floor', kind: 'floor_drain', label: '洗衣机地漏', x_mm: 0, z_mm: 0, width_mm: 120, depth_mm: 120, height_mm: 10, rotation_deg: 0, source: 'user', confidence: 1 })).toBe('washer')
  })
